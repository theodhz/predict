...
var predictionController = (function() {
    ...
    var calculateTotalOutc = function() {
  ...
  data.totalDifferences = sum;

};

var calcBscore = function() {

  data.bScore = data.totalDifferences / data.totalOutcomes
...
return {
  addItem: function(outc, desc, date, prob, reas) {
    ...
    calculateBScore: function() {
      ...
      // Add up outcomes if = 2 or 3
      calculateTotalOutc();

      // Add up differences if outcome = 2 or 3
      calculateTotalDiff();

      // divide Total Differences by Total Outcomes
      calcBscore();
